...
import anniversary from "@bsky-affirmative-bot/shared-configs/json/anniversary.json" with { type: "json" };
import { dateForHoliday, Status } from "@bsky-affirmative-bot/shared-configs";
